    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (FAuth.getCurrentUser().isEmailVerified()) {
                                    mDialog.dismiss();
                                    Toast.makeText(Delivery_Login.this, "Bejelentkeztél!!", Toast.LENGTH_SHORT).show();
                                    ...
                                    ReusableCodeForAll.ShowAlert(Delivery_Login.this, "", "PKérlek igazold vissza az email címedet!");
                                }

                            } else {

                                mDialog.dismiss();
                                ReusableCodeForAll.ShowAlert(Delivery_Login.this, "Hiba!", task.getException().getMessage());
                            }
                        }
                    });
                }
        ...
        txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent Register = new Intent(Delivery_Login.this, com.example.fa.Delivery_registeration.class);
        ...
        Signinphone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent q = new Intent(Delivery_Login.this, com.example.fa.Delivery_LoginPhone.class);
                startActivity(q);
                finish();
            }
        });
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(em)) {
            ...
            if (em.matches(emailpattern)) {
                ...
                email.setErrorEnabled(true);
                email.setError("Kérlek érvényes email címet adj meg!");
            }
