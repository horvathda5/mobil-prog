        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.isEmpty() && code.length() < 6) {
                    entercode.setError("Add meg a kódot!");
        ...
        Resend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(60000, 1000) {
                    ...
                    public void onTick(long millisUntilFinished) {
                        txt.setVisibility(View.VISIBLE);
                        txt.setText("Újraküldése ennyi: " + millisUntilFinished / 1000 + " másodperc múlva!");
                    }
                ...
                .addOnCompleteListener(Delivery_VerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(Delivery_VerifyPhone.this, com.example.fa.MainMenu.class);
                            startActivity(intent);
                            finish();


                        } else {
                            ReusableCodeForAll.ShowAlert(Delivery_VerifyPhone.this, "Hiba!", task.getException().getMessage());
                        }
                    }
                });
    }
