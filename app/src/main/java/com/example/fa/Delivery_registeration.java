...
public class Delivery_registeration extends AppCompatActivity {
    ...
    String[] Veszpremm = {"Veszprem", "Ajka", "Balatonalmadi"};
    String[] Tolna = {"Szekszard", "Paks", "Tolna"};
    String[] Somogy = {"Siofok", "Kaposvár", "Kaposszekcso"};


    String[] Szekszardd = {"Korosi Csoma Sandor u", "Szechenyi u", "Sport u"};


    String[] Veszpremmm = {"Egyetem u", "Stadion u"};
    String[] Siofokk = {"Setany", "Aranypart", "Ezustpart"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Veszprém")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : Veszpremm) {
                        list.add(text);
                    }
                ...
                if (statee.equals("Tolna")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : Tolna) {
                        list.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Delivery_registeration.this, android.R.layout.simple_spinner_item, list);
                ...
                if (statee.equals("Somogy")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : Somogy) {
                        list.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Delivery_registeration.this, android.R.layout.simple_spinner_item, list);
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Szekszard")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Szekszardd) {
                        listt.add(text);
                    }
                ...
                if (cityy.equals("Veszprem")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Veszpremmm) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Delivery_registeration.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
                ...
                if (cityy.equals("Siofok")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Siofokk) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Delivery_registeration.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    ...
                    mDialog.setMessage("regisztráció, kérlek várj...");
                    mDialog.show();
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            builder.setMessage("Sikeres regisztráció! Kérlek igazold vissza az email címedet!");
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(Delivery_registeration.this, com.example.fa.Delivery_VerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(Delivery_registeration.this, "Hiba!", task.getException().getMessage());
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(fname)) {
            ...
            Fname.setError("Vezetéknév szükséges!");
        } else {
            isValidname = true;
        }
        if (TextUtils.isEmpty(lname)) {
            Lname.setErrorEnabled(true);
            Lname.setError("LKeresztnév szükséges!");
        } else {
            isvalidlname = true;
        }
        if (TextUtils.isEmpty(emailid)) {
            Email.setErrorEnabled(true);
            Email.setError("Email szükséges!");
        } else {
            if (emailid.matches(emailpattern)) {
                isValidemail = true;
            } else {
                Email.setErrorEnabled(true);
                Email.setError("EÉrvényes email címet adj meg!");
            }
        ...
        if (TextUtils.isEmpty(password)) {
            ...
            Pass.setError("PJelszó szükséges!");
        } else {
            if (password.length() < 6) {
                Pass.setErrorEnabled(true);
                Pass.setError("Túl gyenge jelszó!");
            } else {
        ...
        if (TextUtils.isEmpty(confirmpassword)) {
            ...
            cfpass.setError("Jelszó megerősítés szükséges!");
        } else {
            if (!password.equals(confirmpassword)) {
                Pass.setErrorEnabled(true);
                Pass.setError("A két jelszó nem egyezik!");
            } else {
        ...
        if (TextUtils.isEmpty(mobile)) {
            ...
            mobileno.setError("Mobilszám szükséges!");
        } else {
            if (mobile.length() < 8) {
                mobileno.setErrorEnabled(true);
                mobileno.setError("Érvénytelen mobilszám!");
            } else {
        ...
        if (TextUtils.isEmpty(house)) {
            ...
            houseno.setError("Nem szabad üresen hagyni!");
        } else {
            isvalidhousestreetno = true;
        }
        if (TextUtils.isEmpty(Area)) {
            area.setErrorEnabled(true);
            area.setError("Nem szabad üresen hagyni!");
        } else {
            isvalidarea = true;
        }
        if (TextUtils.isEmpty(Postcode)) {
            postcode.setErrorEnabled(true);
            postcode.setError("Nem szabad üresen hagyni!");
        } else {
