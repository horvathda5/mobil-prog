...
public class Registeration extends AppCompatActivity {
                                                            ...
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        Intent b = new Intent(Registeration.this, com.example.fa.VerifyPhone.class);
                                                                ...
                                                                mDialog.dismiss();
                                                                ReusableCodeForAll.ShowAlert(Registeration.this,"Hiba!",task.getException().getMessage());
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(lastname)) {
            ...
            lname.setError("Keresztnév szükséges!");
        } else {
            isValidlastname = true;
        }
        if (TextUtils.isEmpty(email)) {
            emaill.setErrorEnabled(true);
            emaill.setError("Email szükséges!");
        } else {
            if (email.matches(emailpattern)) {
                isValidemail = true;
            } else {
                emaill.setErrorEnabled(true);
                emaill.setError("Kérlek érvényes email címet adj meg!");
            }
        ...
        if (TextUtils.isEmpty(password)) {
            ...
            pass.setError("jelszó szükséges!");
        } else {
            if (password.length() < 6) {
                pass.setErrorEnabled(true);
                pass.setError("Túl gyenge jelszó!");
                cmpass.setError("Túl gyenge jelszó!");
            } else {
        ...
        if (TextUtils.isEmpty(confirmpass)) {
            ...
            cmpass.setError("Jelszó megerősítés szükséges!");
        } else {
            if (!password.equals(confirmpass)) {
                pass.setErrorEnabled(true);
                pass.setError("A két jelszó nem egyezik!");
                cmpass.setError("A két jelszó nem egyezik!");
            } else {
        ...
        if (TextUtils.isEmpty(Localaddress)) {
            ...
            localadd.setError("Cím szükséges!");
        } else {
            isValidaddress = true;
        }
