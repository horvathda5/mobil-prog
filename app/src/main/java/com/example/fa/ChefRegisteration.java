...
public class ChefRegisteration extends AppCompatActivity {
                    ...
                    FAuth.createUserWithEmailAndPassword(emailid, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            builder.setMessage("Sikeres regisztráció! Igazold vissza emailben a regisztrációd!");
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(ChefRegisteration.this, com.example.fa.ChefVerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(ChefRegisteration.this, "Hiba!", task.getException().getMessage());
                                ...
                                mDialog.dismiss();
                                ReusableCodeForAll.ShowAlert(ChefRegisteration.this, "EHiba!", task.getException().getMessage());
                            }
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(fname)) {
            ...
            Fname.setError("FVezetéknév szükséges!");
        } else {
            isValidname = true;
        }
        ...
        if (TextUtils.isEmpty(mobile)) {
            ...
            if (mobile.length() < 8) {
                mobileno.setErrorEnabled(true);
                mobileno.setError("Kérlek érvenyes mobilszámot adj meg!");
            } else {
