    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(60000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                txt.setText("Újraküldés ennyi: " + millisUntilFinished / 1000 + " másodperc múlva.");
            }
                ...
                .addOnCompleteListener(ChefVerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(ChefVerifyPhone.this,com.example.fa.MainMenu.class);
                            startActivity(intent);
                            finish();


                        } else {
                            ReusableCodeForAll.ShowAlert(ChefVerifyPhone.this,"Hiba!",task.getException().getMessage());
                        }
                    }
                });
    }
