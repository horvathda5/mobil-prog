        ...
        try {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (FAuth.getCurrentUser().isEmailVerified()) {
                                        mDialog.dismiss();
                                        Toast.makeText(ChefLogin.this, "Bejelentkeztél!!", Toast.LENGTH_SHORT).show();
                                        ...
                                        ReusableCodeForAll.ShowAlert(ChefLogin.this, "", "Kérlek igazold vissza az emailed!");
                                    }

                                } else {

                                    mDialog.dismiss();
                                    ReusableCodeForAll.ShowAlert(ChefLogin.this, "Hiba!", task.getException().getMessage());
                                }
                            }
                        });
            ...
            txt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent Register = new Intent(ChefLogin.this, com.example.fa.ChefRegisteration.class);
            ...
            Signinphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent q = new Intent(ChefLogin.this, com.example.fa.Chefloginphone.class);
                    startActivity(q);
                    finish();
                }
            });
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(em)) {
            ...
            if (em.matches(emailpattern)) {
                ...
                email.setErrorEnabled(true);
                email.setError("Kérlek érvényes emailt adj meg!");
            }
