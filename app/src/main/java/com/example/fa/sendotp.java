        ...
        Resend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(60000, 1000) {
                    ...
                    public void onTick(long millisUntilFinished) {
                        txt.setVisibility(View.VISIBLE);
                        txt.setText("Kód újraküldése ennyi:  " + millisUntilFinished / 1000 + " másodperc múlva!");
                    }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                ReusableCodeForAll.ShowAlert(sendotp.this,"Hiba!",task.getException().getMessage());
                            }
                        }
                    });
        } catch (Exception e) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        ...
                        Toast.makeText(sendotp.this, "Ez a 2.:" + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
