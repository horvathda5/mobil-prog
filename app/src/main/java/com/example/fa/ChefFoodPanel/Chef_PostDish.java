package com.example.fa.ChefFoodPanel;
...
public class Chef_PostDish extends AppCompatActivity {
    ...
    private boolean isValid() {
        ...
        if (TextUtils.isEmpty(description)) {
            ...
            desc.setError("Leírás szükséges!");
        ...
        if (TextUtils.isEmpty(quantity)) {
            ...
            qty.setError("QMennyiség szükséges!");
        } else {
            isvalidQuantity = true;
        }
        if (TextUtils.isEmpty(price)) {
            pri.setErrorEnabled(true);
            pri.setError("Ár szükséges!");
        } else {
            isValidPrice = true;
        }
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(City).child(Sub).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Chef_PostDish.this, "Az étel sikeresen feltöltve!", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Sikeres vágás!", Toast.LENGTH_SHORT).show();
            } else if (resultCode == CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE) {
                Toast.makeText(this, "Sikertelen vágás!" + result.getError(), Toast.LENGTH_SHORT).show();
            }
        }
